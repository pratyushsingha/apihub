...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
  // Access the frontend base URL from environment variables
  ...
  // Construct the reset password link using the frontend base URL and the generated token
  const passwordResetUrl = `${frontendBaseURL}/reset-password/${unHashedToken}`;
